...
#define GAME_NAME						"Quake4 1.4.2 beta 1 EGL_wrap AmigaOS4"			// appears on window titles and errors
...
#define GAME_NAME_QUAKE4		        "Quake4 beta 1 MOD EGL_wrap AmigaOS4"      // appears on window titles and errors
